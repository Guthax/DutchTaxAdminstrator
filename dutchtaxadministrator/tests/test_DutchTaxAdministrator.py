...
from dutchtaxadministrator import dutch_tax_administrator


@pytest.fixture
def window(qtbot):
    """Pass the application to the test functions via a pytest fixture."""
    new_window = DutchTaxAdministrator.DutchTaxAdministrator()
...
def test_window_title(window):
    ...
    assert window.windowTitle() == 'DutchTaxAdministrator'
